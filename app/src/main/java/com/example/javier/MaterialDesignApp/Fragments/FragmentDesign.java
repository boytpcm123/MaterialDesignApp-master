...
public class FragmentDesign extends Fragment {
    ...
    int tabNumber = Variables.BAOMOI_CATEGORIES.length;
    int tabsPaddingTop;
    ...
    public void setupTabs() {
        tabsDesignViewPagerAdapter = new TabsDesignViewPagerAdapter(getFragmentManager(), Variables.BAOMOI_CATEGORIES, tabNumber);
